...
public enum Images {
    ...
    L0D("./src/main/java/it/polimi/ingsw/GUI/graphicResources/board/"),
    ...
    L0R("./src/main/java/it/polimi/ingsw/GUI/graphicResources/board/"),
    L0B("./src/main/java/it/polimi/ingsw/GUI/graphicResources/board/"),
    L0P("./src/main/java/it/polimi/ingsw/GUI/graphicResources/board/"),
